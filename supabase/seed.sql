...
-- ════════════════════════════════════════════════════════════════════════
-- Correr DESPUÉS de schema.sql. Carga un ecosistema completo de ejemplo
-- (con los campos nuevos poblados) para ver el directorio funcionando.
...
insert into administracion (id, razon_social, cuit, condicion_fiscal, domicilio, contacto_nombre, contacto_rol, contacto_cel, contacto_email, etapa_comercial, plan, fecha_alta_contrato) values
  ('a0000000-0000-0000-0000-000000000001', 'Administración Parques del Lago S.A.', '30-71000000-1', 'responsable_inscripto', 'Av. Libertador 1000, Pilar', 'Marcela Gómez', 'Gerente de Operaciones', '+54 9 11 5555-1000', 'operaciones@parquesdellago.com.ar', 'cliente', 'Piloto', '2026-04-01');

-- ── Barrios (misma administración → varios barrios) ──
insert into barrio (id, administracion_id, nombre, localidad, partido, provincia, zona, cantidad_lotes, sistema_acceso, requiere_antecedentes, requiere_seguro_art, requiere_identidad, etapa_activacion) values
  ('b0000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'Parques del Lago', 'Pilar', 'Pilar', 'Buenos Aires', 'GBA Norte', 420, 'Lectora de DNI en garita', true, true, true, 'activo'),
  ('b0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001', 'Altos del Río', 'Escobar', 'Escobar', 'Buenos Aires', 'GBA Norte', 260, 'Tótem con lectura de QR', true, false, true, 'piloto');
...
-- ── Lotes ── (Lucía tiene un lote en cada barrio → propietario multi-barrio)
insert into lote (id, barrio_id, numero, metros2, metros2_jardin, tipo_uso, propietario_id) values
  ...
  ('d0000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000001', 'B-04', 480.00, 300.00, 'residencia_principal', 'c0000000-0000-0000-0000-000000000002'),
  ...
  ('d0000000-0000-0000-0000-000000000004', 'b0000000-0000-0000-0000-000000000002', 'L-07', 540.00, 360.00, 'fin_de_semana',        'c0000000-0000-0000-0000-000000000001');
...
insert into prestador (id, nombre, apellido, razon_social, es_empresa, cuit_cuil, condicion_fiscal, celular, domicilio, tipo_servicio_principal, horario_trabajo, zona_preferente, descripcion, anios_experiencia, cantidad_ayudantes, tarifa_referencia, cbu_alias, activo) values
  ...
  ('e0000000-0000-0000-0000-000000000002', 'Diego', 'Pereyra', 'Jardines del Sur', true, '30-30111222-3', 'responsable_inscripto', '+54 9 11 6666-3002', 'Garín, Escobar', 'jardineria', 'Lun-Sáb 7-15', 'GBA Norte', 'Diseño y paisajismo, riego y poda. Equipo de 3 personas.', 8, 3, 110000.00, 'jardinesdelsur', true),
...
-- Habilitación por barrio (con fechas)
insert into prestador_barrio (prestador_id, barrio_id, habilitado, fecha_habilitacion, fecha_vencimiento_habilitacion) values
  ...
  ('e0000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000001', true, '2026-03-15', '2027-03-15'),
  ('e0000000-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000001', false, null, null);
...
-- ── Verificaciones (SOLO ESTADO; seguro con aseguradora y póliza) ──
insert into verificacion (prestador_id, barrio_id, tipo, estado, fecha_emision, fecha_vencimiento, aseguradora, nro_poliza, validado_por, validado_en) values
  ...
  ('e0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', 'antecedentes_penales', 'verificado', '2026-01-15', '2027-01-15', null, null, 'a0000000-0000-0000-0000-000000000001', now()),
  ('e0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', 'seguro_art',           'verificado', '2026-03-01', '2027-03-01', 'La Segunda ART', 'ART-998877', 'a0000000-0000-0000-0000-000000000001', now()),
  ('e0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', 'identidad',            'verificado', '2026-01-15', null,         null, null, 'a0000000-0000-0000-0000-000000000001', now()),
  -- Diego: identidad y antecedentes OK, seguro vencido
  ('e0000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000001', 'antecedentes_penales', 'verificado', '2025-11-10', '2026-11-10', null, null, 'a0000000-0000-0000-0000-000000000001', now()),
  ('e0000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000001', 'seguro_art',           'vencido',    '2025-02-01', '2026-02-01', 'Provincia ART', 'ART-112233', 'a0000000-0000-0000-0000-000000000001', now()),
  ('e0000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000001', 'identidad',            'verificado', '2025-11-10', null,         null, null, 'a0000000-0000-0000-0000-000000000001', now()),
  -- Carlos: pendiente
  ('e0000000-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000001', 'antecedentes_penales', 'pendiente',  null, null, null, null, null, null),
  ('e0000000-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000001', 'identidad',            'pendiente',  null, null, null, null, null, null);
...
insert into trabajo (id, lote_id, propietario_id, prestador_id, barrio_id, fecha, tipo_servicio, descripcion, monto, comision_plataforma, metodo_pago, estado_pago, fecha_pago, frecuencia, estado) values
  ...
  ('f0000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000002', 'c0000000-0000-0000-0000-000000000002', 'e0000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000001', '2026-06-05', 'jardineria', 'Mantenimiento quincenal', 110000.00, 13200.00, 'efectivo', 'pagado', '2026-06-05', 'quincenal', 'realizado'),
  ('f0000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000002', 'c0000000-0000-0000-0000-000000000002', 'e0000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000001', '2026-06-19', 'poda', 'Poda de arbustos y limpieza', 60000.00, 7200.00, 'mercadopago', 'pendiente', null, 'unico', 'realizado');
